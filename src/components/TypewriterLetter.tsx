...
I want to grow with you, dream with you, and build a lifetime of memories with you, baby 💍💖. Main har mushkil mein tumhara haath pakad kar chalna chahta hoon 🤝. You are my peace, my strength, my happiness 🌸💞. Tum meri aadat nahi ho, tum meri zarurat ho ❤️. You are not just my love — you are my forever ♾️💗.

No words will ever be enough to describe how much I love you, Shruu… but I promise to show you every single day 💌. Hamesha tumhara, har din, har pal 🤍. Forever and always, Shruu 💞✨
  ...
  if (!isOpen) {
    return (
      <div className="text-center py-12">
        ...
        >
          Click to Read My Letter to You 💌
        </button>
      </div>
    );
  }
